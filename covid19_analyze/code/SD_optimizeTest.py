# -*- coding: utf-8 -*-
"""
Created on Sat Jan 23 19:26:33 2021
...
import SD_Polyfit_Optimize as pfo
...
#纽约数据
df = pd.read_excel("D:/项目/毕业设计/资料/covidtracking/SD南达科他(全)/南达科他20201101-20210122.xlsx")
#print(df)
...
res1 = pfo.polyfit_result(df,0.07,15,count1)
...
writer = pd.ExcelWriter('D:/项目/毕业设计/资料/covidtracking/SD南达科他(全)/1.xlsx')
...
writer = pd.ExcelWriter('D:/项目/毕业设计/资料/covidtracking/SD南达科他(全)/2.xlsx')
...
writer = pd.ExcelWriter('D:/项目/毕业设计/资料/covidtracking/SD南达科他(全)/3.xlsx')
...
plt.title("New infected cases(ω=0.05)")
plt.show()
...
#plt.xlabel('Date') #设置x轴名称
plt.ylabel('No. of infect person ') #设置y轴名称
plt.title("New infected cases(ω=0.056)")
plt.show()
...
#plt.xlabel('Date') #设置x轴名称
plt.ylabel('No. of infect person ') #设置y轴名称
plt.title("New infected cases(ω=0.06)")
plt.show()
...
#plt.xlabel('Date') #设置x轴名称
plt.ylabel('No. of infect person ') #设置y轴名称
plt.title("New infected cases(ω=0.065)")
plt.show()
...
#plt.xlabel('Date') #设置x轴名称
plt.ylabel('No. of infect person ') #设置y轴名称
plt.title("Accumulative infected cases(ω=0.05)")
plt.show()
...
#plt.xlabel('Date') #设置x轴名称
plt.ylabel('No. of infect person ') #设置y轴名称
plt.title("Accumulative infected cases(ω=0.056)")
plt.show()
...
#plt.xlabel('Date') #设置x轴名称
plt.ylabel('No. of infect person ') #设置y轴名称
plt.title("Accumulative infected cases(ω=0.06)")
plt.show()
...
#plt.xlabel('Date') #设置x轴名称
plt.ylabel('No. of infect person ') #设置y轴名称
plt.title("Accumulative infected cases(ω=0.065)")
plt.show()